...
export const useChatState = () => {
  ...
  const [assistantModel, setAssistantModel] = useState('ft:gpt-3.5-turbo-1106:growthify:8qwhKSVZ');
  ...
  const [initialThreadMessage, setInitialThreadMessage] = useState('You are an helpful assistant called Matt! introduce yourself');
